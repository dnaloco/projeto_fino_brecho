...
public class ConsultarCaixar extends JInternalFrame {
	...
	public ConsultarCaixar() {
		...
		JLabel lblUltimaAtualizaoPor = new JLabel("Ultima atualizaÃ§Ã£o por:");
		...
		JLabel lblNoHouveFechamento = new JLabel("NÃ£o houve fechamento na data");
		...
		JLabel lblLquido = new JLabel("LÃ­quido:");
		...
		JLabel lblNewLabel = new JLabel("DiferenÃ§a:");
