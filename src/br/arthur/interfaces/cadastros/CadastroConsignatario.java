...
public class CadastroConsignatario extends JInternalFrame {
	...
	public CadastroConsignatario(int id) {
		...
		setFrameIcon(new ImageIcon("images/consigs-small.png"));
		setClosable(true);
		setIconifiable(true);
		...
		springLayout.putConstraint(SpringLayout.NORTH, lblSubtitle, 10,
				SpringLayout.NORTH, getContentPane());
		springLayout.putConstraint(SpringLayout.WEST, lblSubtitle, 10,
				SpringLayout.WEST, getContentPane());
		getContentPane().add(lblSubtitle);

		JPanel panel = new JPanel();
		springLayout.putConstraint(SpringLayout.NORTH, panel, 6,
				SpringLayout.SOUTH, lblSubtitle);
		springLayout.putConstraint(SpringLayout.WEST, panel, 10,
				SpringLayout.WEST, getContentPane());
		springLayout.putConstraint(SpringLayout.SOUTH, panel, 165,
				SpringLayout.SOUTH, lblSubtitle);
		springLayout.putConstraint(SpringLayout.EAST, panel, 468,
				SpringLayout.WEST, getContentPane());
		...
		gbl_panel.columnWeights = new double[] { 0.0, 0.0, 1.0, 0.0, 1.0,
				Double.MIN_VALUE };
		...
		springLayout.putConstraint(SpringLayout.WEST, panel_1, 10,
				SpringLayout.WEST, getContentPane());
		springLayout.putConstraint(SpringLayout.SOUTH, panel_1, -44,
		...
		gbl_panel_1.columnWeights = new double[] { 0.0, 0.0, 1.0, 0.0, 1.0,
				Double.MIN_VALUE };
		...
		springLayout.putConstraint(SpringLayout.WEST, btnSalvar, 371,
				SpringLayout.WEST, getContentPane());
		springLayout.putConstraint(SpringLayout.EAST, btnSalvar, -4,
				...
				if (isValid) {
					...
					if (theId > 0) {
						...
						try {
							...
							JOptionPane.showMessageDialog(null, "Já existe este consignatário cadastrado!");
						}
		...
		springLayout.putConstraint(SpringLayout.NORTH, btnCancelar, 6,
				SpringLayout.SOUTH, panel_1);
		springLayout.putConstraint(SpringLayout.WEST, btnCancelar, 10,
				SpringLayout.WEST, getContentPane());
		springLayout.putConstraint(SpringLayout.EAST, btnCancelar, -365,
				SpringLayout.EAST, getContentPane());
		...
		springLayout.putConstraint(SpringLayout.WEST, button, 26,
				SpringLayout.EAST, lblSubtitle);
		...
		txtRg.setColumns(10);
		springLayout.putConstraint(SpringLayout.EAST, button, -10,
				SpringLayout.EAST, getContentPane());
		...
		btnExcluir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				opcao = JOptionPane.showConfirmDialog(null,
						"Deseja Realmente excluir o consignatário " + theId
				...
				if (opcao == JOptionPane.YES_OPTION) {
					try {
						...
						JOptionPane
								.showMessageDialog(null,
										"Não é possível excluir este consignatário. A entradas ligados ao mesmo.");
						e1.printStackTrace();
					} catch (ConstraintViolationException ex) {
						JOptionPane
								.showMessageDialog(null,
		...
		springLayout.putConstraint(SpringLayout.NORTH, btnExcluir, 6,
				SpringLayout.SOUTH, panel_1);
		springLayout.putConstraint(SpringLayout.WEST, btnExcluir, 6,
				SpringLayout.EAST, btnCancelar);
		springLayout.putConstraint(SpringLayout.EAST, btnExcluir, -161,
				SpringLayout.WEST, btnSalvar);
	...
	protected void populateMe() {
		Consignatario c = ConsignatarioModel.findOneWhere("id",
